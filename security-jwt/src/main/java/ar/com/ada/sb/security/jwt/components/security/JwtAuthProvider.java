package ar.com.ada.sb.security.jwt.components.security;
...
public class JwtAuthProvider {
    ...
    public boolean isBearer(String authorization){
        return authorization != null && authorization.startsWith(authJwtType)
    ...
    private Claims getClaimsFromToken(String token){
        return Jwts.parser().setSigningKey(secretSeed).parseClaimsJws(token).getBody();
    }
}